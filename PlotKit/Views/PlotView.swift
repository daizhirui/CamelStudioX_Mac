...
open class PlotView: NSView {
    ...
    open var insets = NSEdgeInsets(top: 40, left: 60, bottom: 40, right: 60)
    ...
    open func addAxis(_ axis: Axis) {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|[view]|",
            options: NSLayoutConstraint.FormatOptions.alignAllCenterX, metrics: nil, views: views))
    ...
    open func addPointSet(_ pointSet: PointSet, title: String = "") {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-(leftInset)-[view]-(rightInset)-|",
            options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: metrics, views: views))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(topInset)-[view]-(bottomInset)-|",
            options: NSLayoutConstraint.FormatOptions.alignAllCenterX, metrics: metrics, views: views))
    ...
    open func addHeatMap(xInterval: ClosedRange<Double>, yInterval: ClosedRange<Double>, zInterval: ClosedRange<Double>, title: String = "", valueFunction: @escaping HeatMapView.ValueFunction) {
        ...
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "H:|-(leftInset)-[view]-(rightInset)-|",
            options: NSLayoutConstraint.FormatOptions.alignAllCenterY, metrics: metrics as [String : NSNumber]?, views: views))
        addConstraints(NSLayoutConstraint.constraints(withVisualFormat: "V:|-(topInset)-[view]-(bottomInset)-|",
            options: NSLayoutConstraint.FormatOptions.alignAllCenterX, metrics: metrics as [String : NSNumber]?, views: views))
    ...
    open override func updateTrackingAreas() {
        ...
        options.formUnion(NSTrackingArea.Options.activeInActiveApp)
        options.formUnion(NSTrackingArea.Options.mouseMoved)
