...
enum opt_code
{
  ...
  OPT_mplt = 1227,                           /* -mplt */
  OPT_mr10k_cache_barrier_ = 1228,           /* -mr10k-cache-barrier= */
  OPT_mrelax_pic_calls = 1229,               /* -mrelax-pic-calls */
  OPT_mshared = 1230,                        /* -mshared */
  OPT_msingle_float = 1231,                  /* -msingle-float */
  OPT_msmartmips = 1232,                     /* -msmartmips */
  OPT_msoft_float = 1233,                    /* -msoft-float */
  OPT_msplit_addresses = 1234,               /* -msplit-addresses */
  OPT_msym32 = 1235,                         /* -msym32 */
  OPT_msynci = 1236,                         /* -msynci */
  OPT_mtune_ = 1237,                         /* -mtune= */
  OPT_muninit_const_in_rodata = 1238,        /* -muninit-const-in-rodata */
  OPT_mvirt = 1239,                          /* -mvirt */
  OPT_mvr4130_align = 1240,                  /* -mvr4130-align */
  OPT_mxgot = 1241,                          /* -mxgot */
  OPT_mxpa = 1242,                           /* -mxpa */
  OPT_n = 1243,                              /* -n */
  OPT_no_canonical_prefixes = 1244,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1245,              /* -no-integrated-cpp */
  OPT_no_pie = 1246,                         /* -no-pie */
  OPT_noasmopt = 1247,                       /* -noasmopt */
