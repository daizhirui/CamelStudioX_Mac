 ...
 * @return      void
 */
#define RT_UART_Off(port)             MemoryOr32(UART0_CTL_REG|port,0x10)               // UART off
 ...
 * @return      void
 */
#define RT_UART_On(port)              {MemoryAnd32(UART0_CTL_REG|port,~0x10);}          // UART on
 ...
 */
#define RT_UART_Busy(port)            MemoryRead32(UART0_BUSY_REG|port)                // check tx busy
 ...
 * @return      void
 */
#define RT_UART_Write(port, val)      MemoryWrite32(UART0_WRITE_REG|port,val)              // send the data
 ...
 */
#define RT_UART_DataReady(port)       MemoryRead32(UART0_DATA_RDY_REG|port)                // check data ready
 ...
 * @return int  Rx data
 */
#define RT_UART_Read(port)            MemoryRead32(UART0_READ_REG|port)                  // read the data
 ...
 * @return      void
 */
#define RT_UART_IrqOn(port)         MemoryOr32(UART0_CTL_REG|port,1)
 ...
 * @return      void
 */
#define RT_UART_IrqOff(port)        MemoryAnd32(UART0_CTL_REG|port,~1)
 ...
 * @return      void
 */
#define RT_UART_CompareOn(port)       MemoryOr32(UART0_CTL_REG|port,0x2)                // UART compare irq on
 ...
 * @return      void
 */
#define RT_UART_CompareOff(port)      MemoryAnd32(UART0_CTL_REG|port,~0x2)             // UART compare irq off
 ...
 * @return      void
 */
#define RT_UART_SetCompare(port, val)   MemoryOr32(UART0_CTL_REG|port,val<<8)                // set irq compare bits
 ...
 * @return      void
 */
#define RT_UART_ClearIrq(port)        MemoryWrite32(UART0_IRQ_ACK_REG|port,0x0)            // clear irq
 ...
 * @return      void
 */
#define RT_UART_RaiseIrq(port)        MemoryOr32(UART0_CTL_REG|port,0x1)                   // raise irq manually
 ...
 */
#define RT_UART_CheckIrq(port)        MemoryBitAt(UART0_CTL_REG|port,0)                  // Check irq
 ...
 * @return      void
 */
#define RT_UART_LinSyncOn(port)         MemoryOr32(UART0_CTL_REG|port,0x8)               // auto Linsync on
 ...
 * @return      void
 */
#define RT_UART_LinSyncOff(port)        MemoryAnd32(UART0_CTL_REG|port,~0x8)             // auto Linsync off
 ...
 * @return      void
 */
#define RT_UART_LinBreakNormal(port)    MemoryAnd32(UART0_CTL_REG|port,~0x20)            // 13-bit Lin break
 ...
 * @return      void
 */
#define RT_UART_LinBreakExtreme(port)   MemoryOr32(UART0_CTL_REG|port,0x20)              // 26-bit Lin break
 ...
 * @return      void
 */
#define RT_UART_LinSendBreak(port)      MemoryWrite32(UART0_LIN_BREAK_REG|port,0x0)      // send Lin break
 ...
 * @return int  1=enable  0=disable
 */
#define RT_UART_LinCheckIrq(port)       ((MemoryRead32(UART0_CTL_REG|port)&0x4)>>3)        // check Lin irq
 ...
 */
#define RT_UART_GetBrp(port)            MemoryRead32(UART0_BRP_REG|port)                 // get brp value
